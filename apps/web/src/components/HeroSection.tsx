...
import { dockerImages, stats } from '../data/mockData';
        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-md focus:border-primary focus:ring-primary focus:outline-none"
              value={searchQuery}
